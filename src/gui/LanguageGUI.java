...
public class LanguageGUI extends JDialog implements ActionListener{
	 ...
	 * @param language The instance of xml.Language used in your application.
	 * </p>
	 */
	...
	private void createWindow()
	{
		...
		this.setTitle("xml.Language Editor");
	 ...
	 * Save the XML language file at his path (defined in xml.Language.xmlPath)
	 * <p>
	 */
	private void saveXML()
	{
	   try
	   {
	      ...
	      sortie.output(la.getRoot(), new FileOutputStream(Language.xmlPath));
	   }
